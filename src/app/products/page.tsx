        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {products.map((product) => (
            <Link key={product.slug} href={`/products/${product.slug}`} className="group block h-full">
              <div className="bg-[#0a0a0a] border border-[#262626] rounded-2xl p-8 md:p-10 flex flex-col h-full group-hover:border-[#4f46e5]/50 transition-colors relative overflow-hidden">
